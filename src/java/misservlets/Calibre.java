 ...
 * @author roberto
 */
public class Calibre extends HttpServlet {
        ...
        try {
          ...
          String Desc=request.getParameter("descripcion");
             ...
             try{
                       ...
                       PreparedStatement st2 = cn.prepareStatement("INSERT INTO `el_lancero`.`calibre` (`CODIGO_CALIBRE` ,`NOMBRE_CALIBRE` ,`DESCRIPCION_CALIBRE` ) VALUES (NULL , '"+Calibre+"', '"+Desc+"');") ;
          ...
          //  out.println("Insert into arma Values (null,"+marcaArma+","+modeloArma+","+colorArma+","+numSerie+","+numBalistica+","+ precioArma+",1,"+sucursalArma+")");
            ...
            out.println("          <center>\n" +
"              <h3>REGISTRAR CALIBRE</h3> <br> <div "+msg+"</div>  \n"  +
...
"                      </tr>"
                    + "<tr> <td> <font color=\"red\">*</font> Nombre Calibre: </td> "
                    + "<td> <input name='calibre'> </td>"
                    + "<td><div id='myform_calibre_errorloc' class=\"error_strings\"></div></td>"
                    + " </tr>\n" +
"                  \n" +
"                      <tr> <td> <font color=\"red\">*</font> Descripci&oacute;n Calibre: </td> "
                    + "<td> <input name='descripcion'> </td> "
                    + "<td><div id='myform_descripcion_errorloc' class=\"error_strings\"></div></td>"
                    + "</tr>\n   "
...
"                                        \n" +
"                                        frmvalidator.addValidation(\"calibre\",\"req\",\"<span class='nosaved'>Digite la Nombre del CALIBRE</span>\");\n" +
"                                       \n" +
"                                        frmvalidator.addValidation(\"descripcion\",\"req\",\"<span class='nosaved'>Digite descripcion del CALIBRE</span>\");\n" +
...
"                                       \n"         
        + "//]]></script>              ");
            ...
            try{
                       ...
                       ResultSet rs2;            
                        rs2 = st2.executeQuery("select * from calibre");
                           
                      while(rs2.next()){
                      out.println("<tr><td>"+rs2.getString(1)+"</td><td>"+rs2.getString(2)+"</td><td>"+rs2.getString(3)+"");
