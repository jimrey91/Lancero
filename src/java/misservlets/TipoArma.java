 ...
 * @author roberto
 */
public class TipoArma extends HttpServlet {
        ...
        try {
          ...
          String Nombre=request.getParameter("nombre");
             ...
             try{
                       ...
                       PreparedStatement st2 = cn.prepareStatement("INSERT INTO `el_lancero`.`tipo_arma` (`CODIGO_TA` ,`TIPO_TA` )VALUES (NULL , '"+Nombre+"');") ;
          ...
          //  out.println("Insert into arma Values (null,"+marcaArma+","+modeloArma+","+colorArma+","+numSerie+","+numBalistica+","+ precioArma+",1,"+sucursalArma+")");
            ...
            out.println("          <center>\n" +
"              <h3>REGISTRAR TIPO DE ARMA</h3> <br> <div "+msg+"</div>  \n"  +
...
"                                        \n" +
"                                        frmvalidator.addValidation(\"nombre\",\"req\",\"<span class='nosaved'>Digite la Tipo del ARMA</span>\");\n" +   
"                                       \n"         
        + "//]]></script>              ");
            ...
            try{
                       ...
                       ResultSet rs2;            
                        rs2 = st2.executeQuery("select * from tipo_arma");
