        ...
        try {
          ...
          String Marca=request.getParameter("marca");
             ...
             try{
                       ...
                       PreparedStatement st2 = cn.prepareStatement("INSERT INTO `el_lancero`.`marca` (`CODIGO_MARCA` ,`NOMBRE_MARCA` )VALUES (NULL , '"+Marca+"');") ;
          ...
          //  out.println("Insert into arma Values (null,"+marcaArma+","+modeloArma+","+colorArma+","+numSerie+","+numBalistica+","+ precioArma+",1,"+sucursalArma+")");
            ...
            out.println("          <center>\n" +
"              <h3>REGISTRAR MARCA</h3> <br> <div "+msg+"</div>  \n"  +
...
"                      </tr>"
                    + "<tr> <td> <font color=\"red\">*</font> Marca: </td> "
                    + "<td> <input name='marca'> </td> "
                    + "<td><div id='myform_marca_errorloc' class=\"error_strings\"></div></td></tr>\n" +
"                  \n" +
"                      "
...
"                                        \n" +
"                                        frmvalidator.addValidation(\"marca\",\"req\",\"<span class='nosaved'>Digite la MARCA</span>\");\n" +
...
"                                       \n"         
        + "//]]></script>              ");
            ...
            try{
                       ...
                       ResultSet rs2;            
                        rs2 = st2.executeQuery("select * from marca");
