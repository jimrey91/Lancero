...
"              </table>");
              ...
              if(request.getParameter("NombreSucursal")!=null) {
               int sucursal = Integer.parseInt(request.getParameter("NombreSucursal"));
                           ...
                           out.println("<table border=1 cellspacing=0> <tr> <th>COD ACCESORIO</th>  <th> MARCA</th>  <th> TIPO ACCESORIO</th>  <th>COLOR</th>   <th>TALLA ACCESORIO</th>   <th> PRECIO</th>");
                       ...
                       if(request.getParameter("carrito")!=null) { carrito=1;}
                        ...
                        rs2 = st2.executeQuery("SELECT A.Codigo_Acc,B.Nombre_Marca,C.Nombre_Tacc,D.Nombre_Color, A.Talla_Acc, A.Precio_Acc FROM accesorio AS A inner join marca as B ON B.Codigo_Marca=A.Codigo_Marca inner join tipo_accesorio as C ON C.Codigo_Tacc=A.Codigo_Tacc inner join color as D ON A.Codigo_Color=D.Codigo_Color and A.Codigo_Sucursal="+sucursal+" order by B.Nombre_Marca Asc");
                       ...
                       if(carrito==1){ out.println("<th> <a href='Addcarrito?cat=3&Id="+rs2.getString(1)+"'> AGREGAR CARRITO </a> </th>"); }
                       out.println("</tr>\n");
...
"                                        \n" +
"                                        frmvalidator.addValidation(\"NombreSucursal\",\"dontselect=000\",\"<span class='nosaved'>Seleccione una Sucursal de ACCESORIOS</span>\");\n" +    
        "//]]></script>  </center>            ");
