 ...
 * @author roberto
 */
public class TipoAccesorio extends HttpServlet {
        ...
        try {
          ...
          String Desc=request.getParameter("descripcion");
             ...
             try{
                       ...
                       PreparedStatement st2 = cn.prepareStatement("INSERT INTO `el_lancero`.`tipo_accesorio` (`CODIGO_TACC` ,`NOMBRE_TACC` ,`DESCRIPCION_TACC` )VALUES (NULL , '"+Nombre+"', '"+Desc+"');") ;
          ...
          //  out.println("Insert into arma Values (null,"+marcaArma+","+modeloArma+","+colorArma+","+numSerie+","+numBalistica+","+ precioArma+",1,"+sucursalArma+")");
            ...
            out.println("          <center>\n" +
"              <h3>REGISTRAR TIPO DE ACCESORIO</h3> <br> <div "+msg+"</div>  \n"  +
...
"                      </tr>"
                    ...
                    + "</tr>\n" +
"                  \n" +
"                      <tr> <td> <font color=\"red\">*</font> Descripci&oacute;n: </td> "
...
"                                       \n" +
"                                        frmvalidator.addValidation(\"nombre\",\"req\",\"<span class='nosaved'>Digite el Nombre del ACCESORIO</span>\");\n" +
"                                       \n" +
"                                        frmvalidator.addValidation(\"descripcion\",\"req\",\"<span class='nosaved'>Digite la Descripcion del ACCESORIO</span>\");\n" +   
"                                       \n"         
        + "//]]></script>              ");
            ...
            try{
                       ...
                       ResultSet rs2;            
                        rs2 = st2.executeQuery("select * from tipo_accesorio");
